...
const CharacterCreator = () => {
  ...
  const generateImagePrompt = (character) => {
    ...
    return `portrait of a beautiful anime style girl, ${hairColor}${character.description}, ((masterpiece)), (best quality), ((ultra detailed)), professional digital art, detailed face, perfect anatomy, vibrant colors, trending on artstation, soft lighting, cinematic composition, warm colors, dynamic pose, expressive eyes, anime key visual, character design, 8k uhd`;
  };
